...
func (r *UsernameChangeHistoryRepositoryImpl) Create(ctx context.Context, history *entities.UsernameChangeHistory) error {
	...
	return r.usernameChangeHistoryDS.Insert(ctx, history)
}

// ReadListByUserID はユーザーIDで履歴を取得
func (r *UsernameChangeHistoryRepositoryImpl) ReadListByUserID(ctx context.Context, userID uuid.UUID, offset, limit int) ([]*entities.UsernameChangeHistory, error) {
	return r.usernameChangeHistoryDS.SelectListByUserID(ctx, userID, offset, limit)
}

// CountByUserID はユーザーIDで履歴数を取得
func (r *UsernameChangeHistoryRepositoryImpl) CountByUserID(ctx context.Context, userID uuid.UUID) (int64, error) {
	return r.usernameChangeHistoryDS.CountByUserID(ctx, userID)
}
